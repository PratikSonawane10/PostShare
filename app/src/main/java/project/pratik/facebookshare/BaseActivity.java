...
import project.pratik.facebookshare.Adapter.DrawerAdapter;
import project.pratik.facebookshare.Model.DrawerItems;
...
public class BaseActivity extends AppCompatActivity {
    ...
    public void setContentView(int layoutResID) {
        ...
        final String[] tittle = new String[]{"Home", "Logout"};
        final int[] icons = new int[]{R.drawable.home, R.drawable.logout};
        ...
        final int[] selectedicons = new int[]{R.drawable.home_red, R.drawable.logout};
